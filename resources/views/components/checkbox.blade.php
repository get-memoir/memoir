@php
  $classes = [
    ...
    'shadow-xs checked:shadow-none indeterminate:shadow-none disabled:opacity-75 disabled:shadow-none disabled:checked:opacity-50',
...
<div class="flex items-center gap-x-2.5">
  <div class="group grid size-5 grid-cols-1">
    ...
    <svg class="pointer-events-none col-start-1 row-start-1 size-3.5 self-center justify-self-center stroke-current text-(--color-accent-foreground)" viewBox="0 0 14 14" fill="none">
