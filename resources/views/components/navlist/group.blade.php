...
<details {{ $attributes->class('group/disclosure grid') }} {{ $expanded ? 'open' : '' }}>
  <summary class="mb-[2px] flex h-10 w-full cursor-default items-center rounded-lg text-gray-500 hover:bg-gray-800/5 hover:text-gray-800 lg:h-8 dark:text-white/80 dark:hover:bg-white/[7%] dark:hover:text-white">
    <div class="pr-4 pl-3">
