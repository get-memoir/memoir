...
{{-- @llms-title: Prioritize --}}
{{-- @llms-description: How do we prioritize features? --}}
{{-- @llms-route: /company/handbook/prioritize --}}
<x-marketing-handbook-layout :marketing-page="$marketingPage">
  <x-slot name="breadcrumb">
    ...
    <span class="text-gray-500">&gt;</span>
    <span class="text-gray-600">How do we prioritize features?</span>
  </x-slot>
