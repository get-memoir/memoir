    ...
    <section class="p-4 sm:p-8">
      <div class="mx-auto flex max-w-xl flex-col gap-y-8 sm:px-0">
        <x-box :title="__('Need to cancel your account?')">
            ...
            <x-form action="{{ route('settings.account.destroy') }}" method="delete" class="space-y-2" x-data="{
              feedback: '',
              isValid: false,
              async handleSubmit() {
              ...
              <textarea id="feedback" name="feedback" rows="3" x-model="feedback" @input="isValid = feedback.length >= 3" class="block w-full appearance-none px-3 py-2 bg-white dark:bg-white/10 dark:disabled:bg-white/[7%] text-gray-700 placeholder-gray-400 disabled:text-gray-500 disabled:placeholder-gray-400/70 dark:text-gray-300 dark:placeholder-gray-400 dark:disabled:text-gray-400 dark:disabled:placeholder-gray-500 rounded-lg border border-gray-200 border-b-gray-300/80 disabled:border-b-gray-200 dark:border-white/10 dark:disabled:border-white/5 shadow-xs disabled:shadow-none dark:shadow-none aria-invalid:border-red-500" placeholder="{{ __('Your feedback helps us improve our service...') }}"></textarea>
